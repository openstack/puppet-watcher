...
project = u'puppet-watcher Release Notes'
...
htmlhelp_basename = 'puppet-watcherReleaseNotesdoc'
...
texinfo_documents = [
  ('index', 'puppet-watcherReleaseNotes', u'puppet-watcher Release Notes Documentation',
   u'2016, Puppet OpenStack Developers', 'puppet-watcherReleaseNotes', 'One line description of project.',
   'Miscellaneous'),
]
