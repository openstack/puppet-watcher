...
describe 'watcher::keystone::authtoken' do
  ...
  shared_examples 'watcher::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('watcher_config').with(
          :username                       => 'watcher',
          :password                       => 'watcher_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'watcher::keystone::authtoken'
    end
  end
